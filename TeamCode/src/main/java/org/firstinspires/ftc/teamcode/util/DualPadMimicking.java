...
public class DualPadMimicking {
    ...
    public void mergePads(Gamepad gpad1, Gamepad gpad2, double time){
        this.time = time;
    ...
    public void createFile(String name){
        ...
        try {
            FileWriter fw = new FileWriter("/sdcard/" + this.name + ".txt");
            fw.close();
    ...
    public void writeToFile(String input){
        try {
            FileWriter fw = new FileWriter("/sdcard/" + this.name + ".txt",true); //the true will append the new data
    ...
    public void replay(String aFileName){

    }

    public String toString(){
        return time + ", " + a + ", " +  aShift + ", " +  b + ", " +  bShift + ", " +  x + ", " +  xShift + ", " +  y + ", " +  yShift + ", " +  left_bumper + ", " +  left_bumperShift + ", " +  right_bumper + ", " +  right_bumperShift + ", " +
                dpad_up + ", " +  dpad_upShift + ", " +  dpad_left + ", " +  dpad_leftShift + ", " +  dpad_down + ", " +  dpad_downShift + ", " +  dpad_right + ", " +
                dpad_rightShift + ", " +  start + ", " +  startShift + ", " +  back + ", " +  backShift + ", " +  guide + ", " +  guideShift + ", " +  right_stick_button + ", " +
                right_stick_buttonShift + ", " + left_trigger + ", " + right_trigger + ", " + left_stick_x + ", " + left_stick_y + ", " + right_stick_x + ", " + right_stick_y + "\n";
    }
}
